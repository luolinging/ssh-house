...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>养生健康交流网站</TITLE>
                        ...
                        align=center>
                          ...
                          <TR>
                            <TD class=ls height=40 
                              align=left><STRONG>最新求购</STRONG></TD></TR>
                          <TR>
                            <TD>
...
A:active {
	TEXT-DECORATION: none
                               ...
                               CommDAO dao = new CommDAO();
                                for(HashMap m:dao.select("select * from buyinfo  order by id desc")){
                                 %> 
                                <TR>
                                <TD class=xh height=34 vAlign=center 
                                align=left>·<A href="/shhouse/zxiang.jsp?<%=m.get("id") %>" 
