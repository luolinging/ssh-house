                          ...
                          <TR>
                            <TD>
                              ...
                              width="100%" align=left>
                                ...
                                align=left><STRONG>出售信息</STRONG></TD>
                          ...
                          <TR>
                            <TD>
                              ...
                              cellPadding=0 width="100%">
							    ...
							    pageManager.doList("select * from sellinfo where hname like'%"+key+"%' order by id desc");
                                ...
                                align=left>·
                                <A href="newxiang.jsp?id=<%=m.get("id") %>" target=_self>
