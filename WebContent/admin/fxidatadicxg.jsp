...
new CommDAO().update(request,response,"idatadic",ext,true,true); 
HashMap mmm = new CommDAO().getmap(id,"idatadic"); 
%>
<body>
  <form  action="fxidatadicxg.jsp?f=f&id=<%=mmm.get("id")%>"     name="f1" method="post"  onsubmit="return checkform()" >
           ...
           <td width="118" class="main_title_td_center">相关信息</td>
            ...
            cellspacing="0" rules="all" style="WIDTH: 100%; BORDER-COLLAPSE: collapse">
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="24%" align="center" class="main_matter_td">楼房房型</td>
                  <td width="76%" align="left" class="main_matter_td"><input type=text  class='textBox' id='icontent' name='icontent' size=35 /><label id='clabelicontent' /></td>
                </tr>
...
if(icontentobj.value==""){  
document.getElementById("clabelicontent").innerHTML="&nbsp;&nbsp;<font color=red>请输入楼房房型</font>";  
return false;  
}else{ 
document.getElementById("clabelicontent").innerHTML="  ";  
}  
return true;   
}   
