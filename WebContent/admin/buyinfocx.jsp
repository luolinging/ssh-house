...
<body>
  <form  action="buyinfocx.jsp"  name="f1" method="post"  >
...
标题 
&nbsp;:&nbsp; 
<input type=text class='textBox'  size=20 name='title' />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<input type=button   class=''  value='添加信息' onclick="add();" /> &nbsp;&nbsp;</td>
      ...
      <table width="100%" border="0" 
          ...
          <tr 
              onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#f0f7ff'" 
              onmouseout="this.style.backgroundColor=currentcolor">
            <td align="center" class="main_title_td_center2">发布人</td>
...
<td align="center" class="main_title_td_center2">操作</td>
           ...
           <% 
new CommDAO().delete(request,"buyinfo"); 
if(request.getParameter("unameid1")!=null){ 
 new CommDAO().commOper("update buyinfo set uname ='' where id="+request.getParameter("unameid1"));  
} 
if(request.getParameter("unameid2")!=null){ 
 new CommDAO().commOper("update buyinfo set uname ='' where id="+request.getParameter("unameid2"));  
} 
String sql = "select * from buyinfo where 1=1 " ;
 if(!ptitle.equals("")){ 
...
String url = "buyinfocx.jsp?1=1&title="+ptitle+""; 
...
<tr 
            ...
            <td align="center" valign="middle" class="main_matter_td"><%=map.get("tcontent")%></td>
            <td align="center" valign="middle" class="main_matter_td"><%=map.get("tel")%></td>
            <td align="center" valign="middle" class="main_matter_td"><%=map.get("linkmen")%></td>
...
&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
<a onclick="return confirm('确定要删除这条记录吗?')"  href="buyinfocx.jsp?scid=<%=map.get("id")%>">删除</a>
</td>
</tr>
<%}%>
...
<script language=javascript> 
function update(no){ 
pop('buyinfoxg.jsp?id='+no,'信息修改',550,'100%') 
}
</script> 
<script language=javascript> 
function add(){ 
pop('buyinfotj.jsp','信息添加',550,'100%') 
}
</script> 
<%@page import="util.Info"%> 
