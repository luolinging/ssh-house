...
new CommDAO().update(request,response,"mixinfo",ext,true,true); 
HashMap mmm = new CommDAO().getmap(id,"mixinfo"); 
%>
<body>
  <form  action="filemixinfoxg.jsp?f=f&id=<%=mmm.get("id")%>"     name="f1" method="post"  onsubmit="return checkform()" >
