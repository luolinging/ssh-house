...
<%
 ...
 %>
  <form action="/shhouse/admin/ylzx.jsp?f=f" name="f1"  method="post">
    <%

 String hql = "select * from mixinfo where infotype='新闻信息' ";
        String url = "/shhouse/admin/ylzx.jsp?1=1";
    ...
    <td height="154"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F7F7F7" class="main_desk_table">
      ...
      <table width="100%" border="0" 
          ...
          <tr 
            ...
            <td width="" align="center" class="main_title_td_center2">类别</td>
         ...
         %>
          ...
          <%
            ...
            <script language=javascript>
			       function add()
			       {
			       pop("/shhouse/admin/addylzx.jsp","添加信息",700,355);
			       }
			       
			        function update(no)
			       {
			       pop("/shhouse/admin/updateylzx.jsp?id="+no,"修改信息",700,355);
			       }
			       </script>
