...
<body>
  <form  action="adminyuyuecx.jsp"  name="f1" method="post"  >
...
if(request.getParameter("statusid1")!=null){ 
 new CommDAO().commOper("update yuyue set status ='已拒绝' where id="+request.getParameter("statusid1"));  
} 
if(request.getParameter("statusid2")!=null){ 
 new CommDAO().commOper("update yuyue set status ='已接受预约' where id="+request.getParameter("statusid2"));  
} 
...
String url = "adminyuyuecx.jsp?1=1&fcname="+pfcname+""; 
...
<tr 
            ...
            <td align="center" valign="middle" class="main_matter_td"><a href="adminyuyuecx.jsp?value=已拒绝&statusid1=<%=map.get("id")%>">拒绝</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="adminyuyuecx.jsp?value=已接受预约&statusid2=<%=map.get("id")%>">接受</a> </td>
</tr>
<%}%>
