...
ext.put("itype","楼房地区"); 
new CommDAO().insert(request,response,"idatadic",ext,true,true); 
%>
<body>
  <form  action="dqidatadictj.jsp?f=f&tglparentid=<%=tglparentid%>"     name="f1" method="post"  onsubmit="return checkform()" >
