...
ext.put("infotype","学习资料"); 
new CommDAO().insert(request,response,"mixinfo",ext,true,true); 
%>
<body>
  <form  action="filemixinfotj.jsp?f=f&tglparentid=<%=tglparentid%>"     name="f1" method="post"  onsubmit="return checkform()" >
           ...
           <td width="118" class="main_title_td_center">相关信息</td>
            ...
            cellspacing="0" rules="all" style="WIDTH: 100%; BORDER-COLLAPSE: collapse">
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="399" align="center" class="main_matter_td">资料名称</td>
                  <td width="912" align="left" class="main_matter_td">
                    <input type=text  class='textBox' id='title' name='title' size=35 /><label id='clabeltitle' />                 </td>
                </tr>
<tr 
              onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#f0f7ff'" 
              onmouseout="this.style.backgroundColor=currentcolor">
                 
                  <td width="399" align="center" class="main_matter_td">资料简介</td>
                  <td width="912" align="left" class="main_matter_td">
                    <textarea  cols='35'  style='margin-top: 1px;margin-bottom: 1px'  class='textArea'  name='infob'  ></textarea>                 </td>
                </tr>
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="399" align="center" class="main_matter_td">文件</td>
                  <td width="912" align="left" class="main_matter_td">
                    <%=Info.getFileUpInfo()%>                 </td>
                </tr>
...
if(titleobj.value==""){  
document.getElementById("clabeltitle").innerHTML="&nbsp;&nbsp;<font color=red>请输入资料名称</font>";  
return false;  
}else{
