...
new CommDAO().update(request,response,"lyb",ext,true,true); 
HashMap mmm = new CommDAO().getmap(id,"lyb"); 
%>
<body>
  <form  action="lybxg.jsp?f=f&id=<%=mmm.get("id")%>"     name="f1" method="post"  onsubmit="return checkform()" >
           ...
           <td width="118" class="main_title_td_center">相关信息</td>
            ...
            cellspacing="0" rules="all" style="WIDTH: 100%; BORDER-COLLAPSE: collapse">
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="399" align="center" class="main_matter_td">回复内容</td>
                  <td width="912" align="left" class="main_matter_td">
                    <input type=text  class='textBox' id='recontent' name='recontent' size=55 /><label id='clabelrecontent' />                 </td>
                </tr>
