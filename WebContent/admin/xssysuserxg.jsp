...
%>
<body>
  <form  action="xssysuserxg.jsp?f=f&id=<%=mmm.get("id")%>"     name="f1" method="post"  onsubmit="return checkform()" >
           ...
           <td width="118" class="main_title_td_center">相关信息</td>
            ...
            cellspacing="0" rules="all" style="WIDTH: 100%; BORDER-COLLAPSE: collapse">
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="399" align="center" class="main_matter_td">用户名</td>
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="399" align="center" class="main_matter_td">密码</td>
                  <td width="912" align="left" class="main_matter_td">
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="399" align="center" class="main_matter_td">姓名</td>
                  <td width="912" align="left" class="main_matter_td">
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="399" align="center" class="main_matter_td">性别</td>
                  <td width="912" align="left" class="main_matter_td">
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="399" align="center" class="main_matter_td">生日</td>
                  <td width="912" align="left" class="main_matter_td">
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="399" align="center" class="main_matter_td">身份证号</td>
                  <td width="912" align="left" class="main_matter_td">
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="399" align="center" class="main_matter_td">联系地址</td>
                  <td width="912" align="left" class="main_matter_td">
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="399" align="center" class="main_matter_td">相片</td>
                  <td width="912" align="left" class="main_matter_td">
...
<script langushhousescript src='/lpsqglpt/js/My97DatePicker/WdatePicker.js'></script> 
<script langshhouseascript src='/lpsqglpt/js/ajax.js'></script> 
<script lanshhousevascript src='/lpsqglpt/js/popup.js'></script> 
<%@page import="util.Info"%> 
<%@page import="util.Info"%> 
...
var unameobj = document.getElementById("uname");  
if(unameobj.value!=shhousevar) ajax = new AJAX(); 
ajax.post("/lpsqglpt/factory/checkno.jsp?table=sysuser&col=uname&value="+unameobj.value+"&checktype=update&id=<%=mmm.get("id")%>&ttime=<%=Info.getDateStr()%>"); 
