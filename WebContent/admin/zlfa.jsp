...
<%
 ...
 %>
  <form action="/shhouse/admin/zlfa.jsp?f=f" name="f1"  method="post">
    <%

 String hql = "select * from mixinfo where infotype='用户文章' ";
        String url = "/shhouse/admin/zlfa.jsp?1=1";
         ...
         {
          hql+=" and (author ='"+Info.getUser(request).get("uname")+"' )";
         }
           ...
           <td width="118" class="main_title_td_center">相关信息</td>
            ...
            cellspacing="0" rules="all" style="WIDTH: 100%; BORDER-COLLAPSE: collapse">
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="" align="left" class="main_matter_td" height="30">
         ...
         %>
          ...
          <%
            ...
            <script language=javascript>
			       function add()
			       {
			       pop("/shhouse/admin/addzlfa.jsp","添加信息",700,355);
			       }
			       
			        function update(no)
			       {
			       pop("/shhouse/admin/updatezlfa.jsp?id="+no,"修改信息",700,355);
			       }
			       </script>
