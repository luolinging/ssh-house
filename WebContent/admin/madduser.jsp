...
%>
<body>
  <form  action="madduser.jsp?f=f&tglparentid=<%=tglparentid%>"     name="f1" method="post"  onsubmit="return checkform()" >
           ...
           <td width="118" class="main_title_td_center">相关信息</td>
            ...
            cellspacing="0" rules="all" style="WIDTH: 100%; BORDER-COLLAPSE: collapse">
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="201" align="center" class="main_matter_td">用户名</td>
                  <td width="766" align="left" class="main_matter_td">
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="201" align="center" class="main_matter_td">密码</td>
                  <td width="766" align="left" class="main_matter_td">
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="201" align="center" class="main_matter_td">姓名</td>
                  <td width="766" align="left" class="main_matter_td">
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="201" align="center" class="main_matter_td">性别</td>
                  <td width="766" align="left" class="main_matter_td">
                    <span id="sexdanx">
<label><input type=radio checked=checked name='sex' id='sex' value='男' />&nbsp;男 </label>
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="201" align="center" class="main_matter_td">生日</td>
                  <td width="766" align="left" class="main_matter_td">
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="201" align="center" class="main_matter_td">联系电话</td>
                  <td width="766" align="left" class="main_matter_td">
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="201" align="center" class="main_matter_td">身份证号码</td>
                  <td width="766" align="left" class="main_matter_td">
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="201" align="center" class="main_matter_td">住址</td>
                  <td width="766" align="left" class="main_matter_td">
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="201" align="center" class="main_matter_td">相片</td>
                  <td width="766" align="left" class="main_matter_td">
...
if(unameobj.value!=""){  
var ajax = new AJAX();
ajax.post("/shhouse/factory/checkno.jsp?table=sysuser&col=uname&value="+unameobj.value+"&checktype=insert&ttime=<%=Info.getDateStr()%>") 
