...
CommDAO dao = new CommDAO();
 ...
 %>
  <form action="/shhouse/shhouse?ac=updatezlfa&id=<%=id %>" name="f1"  method="post">
        ...
        <td><table width="100%" border="0" 
            cellspacing="0" rules="all" style="WIDTH: 100%; BORDER-COLLAPSE: collapse">
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="620" align="left" class="main_matter_td"><label>
                    <%=Info.getUser(request).get("uname") %><input name="author" type="text" style="display: none" value="<%=Info.getUser(request).get("uname") %>" class="textBox" id="author" size="20" />
                  </label></td>
                </tr>
