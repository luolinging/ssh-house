...
%>
<body>
  <form  action="xssysusertj.jsp?f=f&tglparentid=<%=tglparentid%>"     name="f1" method="post"  onsubmit="return checkform()" >
...
<script languageshhouseipt src='/lpsqglpt/js/My97DatePicker/WdatePicker.js'></script>
<script languagshhouseript src='/lpsqglpt/js/popup.js'></script>
<script languashhousecript src='/lpsqglpt/js/ajax.js'></script>
<%@page import="util.Info"%>
<%@page import="util.Info"%> 
...
var unameobj = document.getElementById("uname");  
if(unameobj.value!="")shhouse ajax = new AJAX();
ajax.post("/lpsqglpt/factory/checkno.jsp?table=sysuser&col=uname&value="+unameobj.value+"&checktype=insert&ttime=<%=Info.getDateStr()%>") 
