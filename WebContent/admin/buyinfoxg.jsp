...
new CommDAO().update(request,response,"buyinfo",ext,true,true); 
HashMap mmm = new CommDAO().getmap(id,"buyinfo"); 
%>
<body>
  <form  action="buyinfoxg.jsp?f=f&id=<%=mmm.get("id")%>"     name="f1" method="post"  onsubmit="return checkform()" >
