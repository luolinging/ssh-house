...
<script language="javascript" src="/shhouse/admin/calendar/WdatePicker.js"></script>
</head>
...
user = dao.select("select * from sysuser where id="+user.get("id")).get(0);
 %>
<form action="/shhouse/shhouse?ac=uppass" name="f1" method="post" >
      ...
      <tr>
        <td>
            ...
            <td colspan="2" align="left" class="main_matter_td"><label> 
             <input name="uname"  class="textBox" type="text" value="<%=user.get("uname") %>"  id="textfield" size="20" /> 
             </label></td>
