...
%>
<body>
  <form  action="lxidatadicxg.jsp?f=f&id=<%=mmm.get("id")%>"     name="f1" method="post"  onsubmit="return checkform()" >
           ...
           <td width="118" class="main_title_td_center">相关信息</td>
            ...
            cellspacing="0" rules="all" style="WIDTH: 100%; BORDER-COLLAPSE: collapse">
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="24%" align="center" class="main_matter_td">楼房类型</td>
...
document.getElementById("clabelicontent").innerHTML="&nbsp;&nbsp;<font color=red>请输入楼房类型</font>";  
return false;  
}else{ 
