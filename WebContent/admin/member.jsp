...
<body>
	...
	<form action="/shhouse/admin/member.jsp?f=f" name="f1" method="post">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				<td height="97">
			       ...
			       function addcl()
			       {
			       pop("/shhouse/admin/addcl.jsp","添加订单",500,287);
			       }
			       </script> &nbsp;&nbsp;&nbsp; <input type="button" onclick="add();"
											name="Submit2" value="添加顾客名字" />
										</td>
									</tr>
								</table>
							</td>
					...
					<table width="100%" border="0" cellspacing="0"
						...
						<%
							CommDAO dao = new CommDAO();
						       ...
						       String url ="/shhouse/admin/member.jsp?1=1";
						     ...
						     for(HashMap m:nlist)
						     {
						      String msql = "select sum(a.danj*a.wunum) from jddans a,fangyd b where b.id=a.did and b.uid= "+m.get("id");

						 int jifen = dao.getInt(msql);
						...
						<tr
							...
							<td align="center" valign="middle" class="main_matter_td"><a
								href="javascript:update('<%=m.get("id")%>')">修改</a>
							</td>
							<td width="81" align="center" class="main_matter_td"><a
								href="/shhouse/admin/member.jsp?did=<%=m.get("id")%>">删除</a>
							</td>
						</tr>
						<%
							}
                 ...
                 function add() 
                 {
                  pop("/shhouse/admin/addmember.jsp","添加顾客名字",500,212);
                 }
                 
                 function update(no) 
                 {
                  pop("/shhouse/admin/updatemember.jsp?id="+no,"修改顾客名字",500,212);
                 }
                 </script>
