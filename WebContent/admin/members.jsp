...
<body>
	<form action="members.jsp" name="f1" method="post">
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			bgcolor="#FFFFFF" class="main_table_frame">
			<tr>
				<td height="136"><table width="100%" border="0" cellpadding="0"
						cellspacing="0" bgcolor="#F7F7F7" class="main_desk_table">
						<tr>
 ...
 %> &nbsp;&nbsp;用户名 &nbsp;:&nbsp; <input
											type=text class='textBox' size=20 name='uname' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;姓名 &nbsp;:&nbsp; <input type=text class='textBox'
											size=20 name='tname' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<table width="100%" border="0" cellspacing="0"
						...
						String url = "members.jsp?1=1&uname="+puname+"&tname="+ptname+""; 
						...
						<tr
							...
							<td align="center" valign="middle" class="main_matter_td"><a
								href="mupdateuser.jsp?id=<%=map.get("id")%>">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a
								onclick="return confirm('确定要删除这条记录吗?')"
								href="members.jsp?scid=<%=map.get("id")%>">删除</a>
							</td>
						</tr>
						<%
							}
						...
						<tr
							onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#f0f7ff'"
							onmouseout="this.style.backgroundColor=currentcolor">
							<td colspan=9 height="15" align="center" valign="middle"
								class="main_matter_td">${page.info}</td>
						</tr>
					</table>
				</td>
			</tr>
...
<%=Info.tform(mmm)%>
<script language=javascript
	src='/shhouse/js/My97DatePicker/WdatePicker.js'></script>
<script language=javascript src='/shhouse/js/popup.js'></script>
<script language=javascript> 
function update(no){ 
pop('mupdateuser.jsp?id='+no,'信息修改',550,280) 
}
</script>
<script language=javascript> 
function add(){ 
pop('madduser.jsp','信息添加',550,280) 
}
</script>
<%@page import="util.Info"%>
