...
HashMap fm = new CommDAO().getmap(id,"pros");
ext.put("tglparentid",tglparentid); 
ext.put("status","已预约"); 
ext.put("fcname",fm.get("title")); 
ext.put("uname",uname); 
new CommDAO().insert(request,response,"yuyue",ext,true,true); 
%>
<body>
  <form  action="yuyuetj.jsp?f=f&id=<%=id%>"     name="f1" method="post"  onsubmit="return checkform()" >
           ...
           <td width="118" class="main_title_td_center">相关信息</td>
            ...
            cellspacing="0" rules="all" style="WIDTH: 100%; BORDER-COLLAPSE: collapse">
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="399" align="center" class="main_matter_td">预约时间</td>
                  <td width="912" align="left" class="main_matter_td">
                    <input type=text size='12' class='textBox'   name='yytime' onclick='WdatePicker();'  />                 </td>
                </tr>
