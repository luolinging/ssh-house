...
new CommDAO().insert(request,response,"sellinfo",ext,true,false); 
%>
<body>
  <form  action="sellinfotj.jsp?f=f&tglparentid=<%=tglparentid%>"     name="f1" method="post"  onsubmit="return checkform()" >
