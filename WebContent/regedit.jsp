                  ...
                  align=left>
                    ...
                    <TR>
                      <TD vAlign=top align=middle>
                       ...
                       <form  action="regedit.jsp?f=f&tglparentid=<%=tglparentid%>"  name="f1" method="post"  onsubmit="return checkform()" >
...
<TR>
                                ...
                                <TD width="74%" height=30 
                                align=left vAlign=center class=xh><span id="sexdanx"><label><input type=radio checked=checked name='sex' id='sex' value='男' />&nbsp;男 </label>
