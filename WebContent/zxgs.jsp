                          ...
                          <TR>
                            <TD>
                              ...
                              width="100%" align=left>
                                ...
                                align=left><STRONG>求购信息</STRONG></TD>
                          ...
                          <TR>
                            <TD>
                              ...
                              cellPadding=0 width="100%">
                                ...
                                PageManager pageManager = PageManager.getPage("zxgs.jsp?1=1",16, request);
							    pageManager.doList("select * from buyinfo where 1=1 and title like'%"+key+"%' order by id desc");
