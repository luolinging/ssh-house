            ...
            <TABLE class=mt border=0 cellSpacing=0 cellPadding=0 width=925>
              ...
              <TR>
                        ...
                        <TABLE border=0 cellSpacing=0 cellPadding=0 
                          width="96%"><TBODY>
                           ...
                           <TR>
                                ...
                                <TD class=ls height=24  colspan="2" vAlign=bottom  
                                align=left>            
               ...
               <table width="100%">
                ...
                &nbsp;&nbsp;信息查询 : 
                <label>
                <input name="key1" type="radio" id="a" value="radio" checked>
                
                房屋</label>
                <label>
                <input type="radio" name="key1" id="b" value="radio">
                
                求购</label>
                <label>
                <input type="radio" name="key1" id="c" value="radio">
                
                出售</label>
                <label></label>
                </td>
                   <td width="16%"><input type="text" name="key" style="height:12px" id="key" size="18"></td>
                   <td width="34%"><input type="button" onClick="sub()" name="button" id="button" style="border: 1px" value="查询"></td>
                 </tr></table>
                          ...
                          <TR>
                            <TD>
                              ...
                              width="100%" align=left>
                                ...
                                align=left><STRONG>网站简介</STRONG></TD></TR>
                          ...
                          <TR>
                            <TD>
                              ...
                              width="100%" align=left>
                                ...
                                align=left><STRONG>&nbsp;新闻信息</STRONG></TD>
                          ...
                          <TR>
                            <TD vAlign=top>
                              ...
                              cellPadding=0 width="100%">
                                ...
                                <TR>
                                <TD align="center">
                               <img src="upfile/<%=dao.select("select * from mixinfo where infotype='新闻信息' order by id desc").get(0).get("filename") %>" height="110" >
...
A:active {
	TEXT-DECORATION: none
                                ...
                                <%
                                for(HashMap m:dao.select("select * from mixinfo where infotype='新闻信息' order by id desc")){
                                 %>
                                <TR>
                                <TD class=xh height=24 vAlign=center 
                                align=left>·
                                <A href="tnewxiang.jsp?id=<%=m.get("id") %>" target=_self>
                          ...
                          <TR>
                            <TD>
                              ...
                              width="100%" align=left>
                                ...
                                <TR>
                                <TD class=ls height=24 vAlign=bottom width=582 
                                align=left><STRONG>&nbsp;最新房产信息</STRONG></TD>
                                <TD class=ls vAlign=bottom width=78 
                                align=right><A 
...
A:active {
	TEXT-DECORATION: none
                                ...
                                <%
                                for(HashMap m:dao.select("select * from pros where 1=1 order by id desc",1,5)){
                                 %>
                                <TR>
                                <TD class=xh height=24 vAlign=center 
                                align=left>·
                                <A href="zxiang.jsp?id=<%=m.get("id") %>" target=_self>
                                    <%=Info.subStr(m.get("hname").toString(),30)  %></A> 
                                    
                                    &nbsp;&nbsp;<%=Info.subStr(m.get("ftype").toString(),30)  %>&nbsp;
                                ...
                                <TR>
                                <TD>
                                <img src="upfile/<%=dao.select("select * from pros where 1=1 order by id desc").get(0).get("filename") %>" height="110" >
