  ...
  <TR>
    <TD vAlign=top>
      ...
      <jsp:include page="top.jsp"></jsp:include>
                  ...
                  HashMap map = dao.getmap(id,"buyinfo");
                   %>
                          ...
                          <TR>
                            <TD>
                             ...
                             &nbsp;&nbsp; 发布人 : <%=map.get("uname") %>
                               ...
                               <br /><br />
                               内容 : <%=map.get("tcontent") %><table><tr><td height="5"></td><tr></table> 
                               联系电话 : <%=map.get("tel") %><table><tr><td height="5"></td><tr></table>
                               联系人 : <%=map.get("linkmen") %><table><tr><td height="5"></td><tr></table> 
